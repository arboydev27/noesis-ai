...
const Navbar = ({ toggleSidebar }: NavbarProps) => {
  return (
    ...
    <div className="absolute top-0 left-0 w-full p-3 md:p-4 px-10 md:px-15 lg:px-20 xl:px-25 flex flex-row items-center justify-between z-20 bg-white/20 text-[#130261] backdrop-blur-md shadow-md ring-1 ring-white/30 hover:bg-white/30 transition-all">
      {" "}
