...
<p float="left">
  <img src="previews/preview1.png" width="100%" alt="Landing page view showing an animation and a prompt searching box" />
  <img src="previews/preview2.png" width="100%" alt="View of the conversation between a user and the LLM" />
</p>
